...
export class XMLscene extends CGFscene {
  ...
  init(application) {
    ...
    this.gameOrchestrator.gameboard.resetBoard();
  ...
  changeScene(){
    if(!(this.gameOrchestrator.state == "renderPossibleMoves" || this.gameOrchestrator.state == "menu")){
      console.warn("Cant change scene in current state");
      return;
    }
    ...
    if(this.filename == "underwaterScene.xml"){
      this.graph.reinit("outsideScene.xml");
      this.filename = "outsideScene.xml";
    }
    else{
      this.graph.reinit("underwaterScene.xml");
      this.filename = "underwaterScene.xml";
    }
  ...
  onGraphLoaded() {
    ...
    this.updateChannel();
    this.selectedCamera = this.previousCamera;
    this.updateCamera();
  }
  ...
  logPicking()
	{
            ...
            this.gameOrchestrator.handlePick(obj, customId);
